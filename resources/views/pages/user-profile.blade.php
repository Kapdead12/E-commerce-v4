        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <!-- Mensaje de error -->
                    @if (session('error'))
                        <div class="alert alert-danger text-white" role="alert" style="background-color: #FA0707; border-color: #FA0707;">
                    ...
                    @if ($errors->any())
                        <div class="btn btn-light text-white" role="alert" style="background-color: #FA0707; border-color: #FA0707;">
                            <strong>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="surname"  value="{{ old('surname', auth()->user()->surname) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="password" type="password" name="password" placeholder="Enter new password" autocomplete="new-password">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="password_confirmation" type="password" name="password_confirmation" placeholder="Confirm new password" autocomplete="new-password">
                                    </div>
