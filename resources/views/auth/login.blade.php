                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.perform') }}">
                                        ...
                                        <div class="flex flex-col mb-3 position-relative">
                                            ...
                                            <button type="button" class="btn btn-warning position-absolute end-0 top-0 mt-1 me-0" id="togglePassword">
                                                <i class="fas fa-eye" id="toggleIcon"></i>
                                            </button>
                                        </div>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" name="remember" type="checkbox" id="rememberMe">
                                            <p class="form-check-label mt-1" for="rememberMe">Remember me</p>
                                        </div>
