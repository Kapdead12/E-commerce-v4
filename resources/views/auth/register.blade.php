                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="surname" class="form-control" placeholder="Surname" aria-label="Surname" value="{{ old('surname') }}" >
                                ...
                                <div class="flex flex-col mb-3">
                                    <input type="text" name="phone" class="form-control" placeholder="Phone" aria-label="Phone" value="{{ old('phone') }}" >
