...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Permisos de Usuario'])
    <div class="row mt-4 mx-4">
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="px-5 py-4 bg-white border-0 shadow-lg sm:rounded-3xl">
                        <h1 class="text-2xl font-bold mb-4">Editar Permisos de Usuario</h1>
                        ...
                        <form action="{{ route('users.updatePermisos', $user->id) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
